...
$id = mysqli_real_escape_string($link, $_REQUEST['datat']);
$sql = "SELECT * FROM tranzactii where datatranzactiei= '$id'";
...
<body>
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.css">
    ...
    <div class="wrapper">
       ...
       <p><a class="btn btn-primary" href="cautaclient.php">Cautare client.</a>.</p> 
    </div>    
</body>
</html>